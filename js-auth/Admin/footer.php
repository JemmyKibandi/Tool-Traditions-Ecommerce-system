                        ...
                        <div class="footer-widget">
                            ...
                            <div class="widget-social">
                                <ul>
                                    ...
                                    <li><a class="youtube" href="#"><i class="icon-youtube2"></i></a></li>
                                    <li><a class="instagram" href="#"><i class="icon-instagram2"></i></a></li>
                                    <li><a class="linkedin" href="#"><i class="icon-linkedin2"></i></a></li>
                                </ul>
                            </div>
                        </div>
                        <!-- footer Widget End -->
